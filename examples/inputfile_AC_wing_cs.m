function [AC,FC] = inputfile_AC_wing_cs
...
AC(1).SubSurf(1).RotAngle = 0*pi/180;%control surface rotation angle
...
AC(1).SubSurf(2).RotAngle = 0*pi/180;%control surface rotation angle
