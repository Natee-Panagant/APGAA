function panelDat=MappedMeshStructure(AC,AcSurf,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Grid generation
x2 = AcSurf.Right.Xw; y2 = AcSurf.Right.Yw; z2 = AcSurf.Right.Zw;
[nchord,nspan] = size(x2);
nspan = nspan-1; nchord = nchord-1;
nwake = 1;% to be modified
...
% Store all outputs in structure variable
