...
% Rotating the data from Cartesian coordinate (X Y Z)
% AxisVec is a vector of rotational axis
% RefPt is a vector of rotational point
% Alpha is a rotational angle (rad)
