...
AC(1).Airfoil='N64210.dat';% Airfoil file
...
AC(1).nSpan=10;% no. of spanwise sections for wing surfaces
AC(1).nChord=15;% no. of chordwise sections for wing surfaces

AC(1).SubSurf(1).Name='Flap';% flap surface
AC(1).SubSurf(1).SpanData=[0.1 0.6 4];% span percentage interval, nspan
...
AC(2).Airfoil='naca0012.DAT';% Airfoil file
